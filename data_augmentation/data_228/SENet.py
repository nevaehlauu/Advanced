...
class SENet(nn.Module):
    def __init__(self, block, num_blocks, features_num, num_classes):
...
def SENet18(in_channels, classes):
    return SENet(PreActBlock, [2, 2, 2, 2], features_num=in_channels, num_classes=classes)


def Net(in_channels, classes):
    return SENet18(in_channels, classes)