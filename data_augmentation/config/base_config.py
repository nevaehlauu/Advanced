...
cfg.model.params.generic.classification_name = "" # 选择不同任务
...
cfg.datasets.train.add_filter = "False"  # 是否进行数据增广以及数据增广形式
cfg.datasets.train.wavelet = "db4"
cfg.datasets.train.level = 2
cfg.datasets.train.data_format = "dat"  # 数据集的格式
cfg.datasets.train.well_use_num = 100 # 使用的井数
########################################################################################################################
...
cfg.datasets.val.add_filter = "False"  # 是否进行数据增广以及数据增广形式
cfg.datasets.train.wavelet = "db4"
cfg.datasets.train.level = 2
cfg.datasets.val.data_format = "dat"  # 是否抛弃异常值
cfg.datasets.val.well_use_num = 18 # 使用的井数
########################################################################################################################
