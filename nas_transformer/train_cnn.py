...
import time
from dataloader.dataloader import dataloader, dataloader_split
# from model.resnet import Net_1d as Net
...
def parse_args():
    ...
    parser.add_argument("--log_dir_path", default="log/senet_log/", help="日志文件存储位置")
    parser.add_argument("--print_period", default=10, help="打印间隔")
    parser.add_argument("--pretrained", default=False, help="是否加载预训练模型")
    parser.add_argument("--pretrained_filepath", default="log/senet_log/12_26_2024__21_42_33/best_epoch_model.pth", help="预训练模型位置")
    ...
    parser.add_argument("--train_well_num", default=1, help="进行训练的井数")
