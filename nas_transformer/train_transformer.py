...
from model.transformer_senet import Net
...
def parse_args():
    ...
    parser.add_argument("--log_dir_path", default="log/transformer/", help="日志文件存储位置")
...
def main(args):
    ...
    if args.pretrained == True and args.pretrained_filepath is not None and Path(args.pretrained_filepath).exists():
        ...
        net_dict = model.src_embed.embedding.state_dict()
        ...
        model.src_embed.embedding.load_state_dict(net_dict, strict=True)
